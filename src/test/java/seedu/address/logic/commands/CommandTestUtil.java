...
public class CommandTestUtil {
    ...
    public static final String VALID_PASSWORD_AMY = "a1b2";
    public static final String VALID_PASSWORD_BOB = "a3c4";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withNRIC(VALID_NRIC_AMY)
                .withTags(VALID_TAG_FRIEND).withPassword(VALID_PASSWORD_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withNRIC(VALID_NRIC_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withName(VALID_PASSWORD_BOB).build();
    }
